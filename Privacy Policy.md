...
Welcome to Save Poppy Ball : Playtime app for Android!

This is an open source Android app developed by Empty Box. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
